...
Pod::Spec.new do |s|
  ...
  s.subspec "React-cxxreact" do |ss|
    ...
    ss.compiler_flags         = folly_compiler_flags + ' ' + boost_compiler_flags
    ss.pod_target_xcconfig    = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/boost-for-react-native\" \"$(PODS_ROOT)/RCT-Folly\" \"$(PODS_ROOT)/DoubleConversion\" \"$(PODS_ROOT)/ReactCommon/cxxreact\"" }
  ...
  s.subspec "React-jsiexecutor" do |ss|
    ...
    ss.compiler_flags         = folly_compiler_flags + ' ' + boost_compiler_flags
    ss.pod_target_xcconfig    = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/boost-for-react-native\" \"$(PODS_ROOT)/RCT-Folly\" \"$(PODS_ROOT)/DoubleConversion\"  \"$(PODS_ROOT)/ReactCommon/jsiexecutor/jsireact\"" }
  ...
  s.subspec "React-Core" do |ss|
    ...
    ss.framework              = "JavaScriptCore"
    ss.library                = "stdc++"
    ss.pod_target_xcconfig    = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/boost-for-react-native\" \"$(PODS_ROOT)/DoubleConversion\" \"$(PODS_ROOT)/RCT-Folly\" \"${PODS_ROOT}/Headers/Public/React-hermes\" \"${PODS_ROOT}/Headers/Public/hermes-engine\" \"${PODS_ROOT}/React\"", "DEFINES_MODULE" => "YES" }
    ...
    #   sss.platforms = { :osx => "10.14", :ios => "11.0" }
  ...
  s.subspec "ReactCommon" do |ss|
    ...
    ss.subspec "turbomodule" do |sss|
      ...
      sss.subspec "react_debug_core" do |ssss|
        ssss.source_files = "react/debug/*.{cpp,h}"
      end
